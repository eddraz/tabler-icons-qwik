export const IconVirusOff = () => {
  return (
    <>
      ...
      <path d="M8.469 8.46a5 5 0 0 0 7.058 7.084"></path>
      <path d="M16.913 12.936a5 5 0 0 0 -5.826 -5.853"></path>
      ...
      <path d="M18.364 18.363l-.707 .707"></path>
      ...
      <path d="M5.636 5.637l-.707 .707"></path>
    </>
  );
};
