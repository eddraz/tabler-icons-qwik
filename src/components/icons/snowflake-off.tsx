export const IconSnowflakeOff = () => {
  return (
    <>
      <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
      <path d="M10 4l2 1l2 -1"></path>
      <path d="M12 2v6m1.196 1.186l1.804 1.034"></path>
      <path d="M17.928 6.268l.134 2.232l1.866 1.232"></path>
      <path d="M20.66 7l-5.629 3.25l-.031 .75"></path>
      <path d="M19.928 14.268l-1.015 .67"></path>
      <path d="M14.212 14.226l-2.171 1.262"></path>
      ...
      <path d="M3.34 7l5.629 3.25l.802 -.466"></path>
