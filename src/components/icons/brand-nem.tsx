export const IconBrandNem = () => {
  return (
    <>
      ...
      <path d="M2.1 7.07c2.073 6.72 5.373 7.697 9.9 2.93c0 -4 1.357 -6.353 4.07 -7.06l.59 -.11"></path>
      <path d="M16.35 18.51s2.65 -5.51 -4.35 -8.51"></path>
    </>
  );
};
